...
<script>
// import HelloWorld from '../../doc/vue电商/10.vuex/code/vuex-demo2/src/components/HelloWorld.vue'
export default {
...
.login_box {
  ...
  .avatar_box {
    height: 130px;
    width: 130px;
    border: 1px solid rgb(125,190,210);
    border-radius: 50%;
    padding: 10px;
    box-shadow: 0 0 10px rgb(125,190,210);
    position: absolute;
    left: 50%;
    transform: translate(-50%, -50%);
    background-color: rgb(125,190,210);
